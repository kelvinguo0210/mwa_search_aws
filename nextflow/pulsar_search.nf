...
if ( params.fits_file ) {
    ...
    fits_file = Channel.fromPath( "${params.fits_file_dir}", checkIfExists: true )
...
if ( params.fits_file_dir ) {
    ...
    println("No fits files given, please ensure dir/files exist. Exiting.")
    exit(0)
}
